...
exports.config = {
    ...
    specs: [
        'test_scenarios/feature_files/angel-applyjob.feature'
    ],
    directConnect: true,
    ...
    cucumberOpts: {
        ...
        strict: true,
        require: 'test_scenarios/step_definitions/angel-jobapply-stepdef.js',
        tags: false,
        profile: false,
        'no-source': true,
    },
    ...
    plugins: [
        {
            ...
            options:{
                ...
                customData: {
                    ...
                    data: [
                        {label: 'Project', value: 'Apply for Angel.co Job Test Automation'},
